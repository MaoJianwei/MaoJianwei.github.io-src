...
>
 ...
 <br /><br />
![MYpicture]({{site.url}}/resources/picture/2015/07/YouYa/.png) <br /><br />
...
　　虽然过程中遇到了一些难以理解的收发流程，但是我始终相信TCP这个东西在互联网上跑了这么多年，不会说在通信交互的机制上有什么BUG，一定是流程中出了什么样的意外情况导致了异常的收发，甚至连接的RST中断。 　　细粒度地分析实际通信场景、bits协议标志位、Seq、Ack，一定能找到问题症结所在！
